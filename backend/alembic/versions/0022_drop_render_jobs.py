"""drop render jobs (feature reverted)

Revision ID: 0022_drop_render_jobs
Revises: 0021_render_job_retry
...
revision: str = "0022_drop_render_jobs"
down_revision: Union[str, Sequence[str], None] = "0021_render_job_retry"
...
def downgrade() -> None:
    # Recreates the table at its final shape (0019 + 0020 + 0021).
    op.create_table(
        "render_jobs",
