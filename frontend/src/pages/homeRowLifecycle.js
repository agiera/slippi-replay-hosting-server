...
function isLiveSourceVisible(source, streamEvents, completedFiles, nowMs, preservedTerminalRowKeys) {
  ...
  // Only surface a live/finalizing row once partial-SLP parsing has yielded
  // roster metadata (players/stage context comes from the replay bytes, not
  // just FTP session start).
